...
| `OPENAI_API_MODEL_NAME_backup`                | `false` |                                                                                          | 回顾生成的备用模型。支持英文逗号分隔多个模型，主模型失败或返回无法修复的非法 JSON 时按顺序重试。                                                                                                                                                                                                                                      |
...
| `CHECK_MODEL`                                 | `false` |                                                                                          | 可选的 JSON 校验模型。流程为：程序修复 JSON -> CHECK_MODEL 修复 -> 程序再次校验 -> 失败时切换备用模型。                                                                                                                                                                                                                          |
| `CHECK_MODEL_backup`                          | `false` |                                                                                          | `CHECK_MODEL` 的备用模型。支持英文逗号分隔多个模型，`CHECK_MODEL` 失败时按顺序重试。                                                                                                                                                                                                                                              |
| `OPENAI_FORCE_CHECK_MODEL_FAILURE`            | `false` | `0`                                                                                      | 测试开关。强制 CHECK_MODEL 修复调用失败，用于验证备用模型切换路径。                                                                                                                                                                                                                                                                   |
| `OPENAI_FORCE_INVALID_RECAP_JSON_FOR_TEST`    | `false` | `0`                                                                                      | 测试开关。将回顾模型输出替换为故意不合法的 JSON 片段，用于验证修复链路。                                                                                                                                                                                                                                                                     |
| `OPENAI_FORCE_CONDENSED_PRIMARY_FAILURE_FOR_TEST` | `false` | `0`                                                                                      | 测试开关。强制 `SARCASTIC_CONDENSED_MODEL_NAME` 失败一次，并切换到 `SARCASTIC_CONDENSED_MODEL_NAME_backup`。                                                                                                                                                                                                                                                               |
| `OPENAI_VERBOSE_PAYLOAD_LOGS`                 | `false` | `0`                                                                                      | 调试开关。输出 recap/check_model 的完整 OpenAI request/response body。建议仅在排查期间开启。                                                                                                                                                                                                                                                     |
| `SARCASTIC_CONDENSED_SYSTEM_PROMPT`           | `false` |                                                                                          | 自定义浓缩总结的系统提示。如果未设置，则使用代码中的默认提示。                                                                                                                                                                                                                                                                                                                                                                |
| `SARCASTIC_CONDENSED_USER_PROMPT`             | `false` |                                                                                          | 自定义浓缩总结的用戶提示模板。應包含 `{{ .ChatHistory }}` 占位符。如果未設置，則使用代碼中的默認提示。                                                                                                                                                                                                                                                                                                                                                                |
| `SARCASTIC_CONDENSED_MODEL_NAME`              | `false` |                                                                                          | 专门用于浓缩总结的 OpenAI 模型名称。如果未设置，则使用与 `OPENAI_API_MODEL_NAME` 相同的模型。这允许为浓缩总结使用不同的模型（例如 `gpt-4`），同时为其他操作使用更便宜的模型。                                                                                                                                                                                                                                                                                                                                                                |
| `SARCASTIC_CONDENSED_MODEL_NAME_backup`       | `false` |                                                                                          | 浓缩总结的备用模型。支持英文逗号分隔多个模型，主模型失败或返回空内容时按顺序重试。                                                                                                                                                                                                                                                                              |
| `CHAT_HISTORIES_SUMMARIZATION_LANGUAGE`       | `false` | `Simplified Chinese`                                                                     | 聊天历史总结输出的语言。控制提示模板中 `{{ .Language }}` 使用的语言。例如：`English`、`Traditional Chinese`、`Japanese` 等。如果未设置，默认为 `Simplified Chinese`。                                                                                                                                                                                                                                                                                                                                                                |
