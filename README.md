...
| `OPENAI_API_MODEL_NAME_backup`                | `false`  |                                                                                          | Backup models for recap generation. Supports comma-separated model names and retries in order when the primary model fails or produces unrecoverable invalid JSON.                                                                                                                                                                                                          |
...
| `CHECK_MODEL`                                 | `false`  |                                                                                          | Optional model used to validate/repair recap JSON format. The flow is: code-based repair -> check model repair -> code-based validation again -> fallback model.                                                                                                                                                                                                          |
| `CHECK_MODEL_backup`                          | `false`  |                                                                                          | Optional backup models for `CHECK_MODEL`. Supports comma-separated model names and retries in order when `CHECK_MODEL` fails.                                                                                                                                                                                                                                            |
| `OPENAI_FORCE_CHECK_MODEL_FAILURE`            | `false`  | `0`                                                                                      | Testing switch. Forces CHECK_MODEL repair call to fail so you can validate backup model fallback behavior.                                                                                                                                                                                                                                                               |
| `OPENAI_FORCE_INVALID_RECAP_JSON_FOR_TEST`    | `false`  | `0`                                                                                      | Testing switch. Overrides recap model output with intentionally invalid JSON payload.                                                                                                                                                                                                                                                                                     |
| `OPENAI_FORCE_CONDENSED_PRIMARY_FAILURE_FOR_TEST` | `false`  | `0`                                                                                      | Testing switch. Forces `SARCASTIC_CONDENSED_MODEL_NAME` to fail once and switch to `SARCASTIC_CONDENSED_MODEL_NAME_backup`.                                                                                                                                                                                                                                            |
| `OPENAI_VERBOSE_PAYLOAD_LOGS`                 | `false`  | `0`                                                                                      | Debug switch. Logs full OpenAI request/response payload bodies for recap/check-model flow. Enable only for troubleshooting due sensitive/large logs.                                                                                                                                                                                                                     |
| `SARCASTIC_CONDENSED_SYSTEM_PROMPT`           | `false`  |                                                                                          | Custom system prompt for sarcastic condensed summaries. If not set, uses the default prompt in the code.                                                                                                                                                                                                                                                                |
| `SARCASTIC_CONDENSED_USER_PROMPT`             | `false`  |                                                                                          | Custom user prompt template for sarcastic condensed summaries. Should include `{{ .ChatHistory }}` placeholder. If not set, uses the default prompt in the code.                                                                                                                                                                                                       |
| `SARCASTIC_CONDENSED_MODEL_NAME`              | `false`  |                                                                                          | OpenAI model name specifically for sarcastic condensed summaries. If not set, uses the same model as `OPENAI_API_MODEL_NAME`. This allows using a different model (e.g., `gpt-4`) for sarcastic summaries while using a cheaper model for other operations.                                                                                                          |
| `SARCASTIC_CONDENSED_MODEL_NAME_backup`       | `false`  |                                                                                          | Backup models used when `SARCASTIC_CONDENSED_MODEL_NAME` fails or returns empty content. Supports comma-separated model names and retries in order.                                                                                                                                                                                                                     |
| `CHAT_HISTORIES_SUMMARIZATION_LANGUAGE`       | `false`  | `Simplified Chinese`                                                                     | Language for chat history summarization output. Controls the language used in the prompt template `{{ .Language }}`. Examples: `English`, `Traditional Chinese`, `Japanese`, etc. If not set, defaults to `Simplified Chinese`.                                                                                                                                      |
