...
func (tcd *TelegramChatDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(telegramchat.Table, sqlgraph.NewFieldSpec(telegramchat.FieldID, field.TypeInt64))
	_spec.Node.Schema = tcd.schemaConfig.TelegramChat
